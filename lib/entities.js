(() => {
    ...
    Entity.prototype.getAll = function getEntities (options, callback) {
        ...
        if (options !== null && typeof options === 'object') {
            ...
            models.search[self.entity].validate(options, function (err) {
                if (err) {
                    return callback(err);
                }
        ...
        models[self.entity].validate(createInfo, function (err) {
            ...
            return self._request({
                ...
                if (err || req.statusCode !== 201) {
                    ...
                    return callback(new Error(err || JSON.stringify(data)), req);
                }
    ...
    Entity.prototype.update = function updateEntity (entityNameId, updInfo, callback) {
        ...
        models.search[self.entity].validate(updInfo, function (err) {
            if (err) {
                return callback(err);
            }
