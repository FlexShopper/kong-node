(function () {
    ...
    Apis.prototype.update = function updateApi (apiNameId, updInfo, callback) {
        if (!apiNameId || typeof apiNameId !== 'string') {
            return callback(
                new Error('A name or id of an API is required and it must a string')
            );
    ...
    Apis.prototype.upsert = function upsertApi (upsInfo, callback) {
    ...
    Apis.prototype.delete = function deleteApi (apiNameId, callback) {
        if (!apiNameId || typeof apiNameId !== 'string') {
            return callback(
                new Error('A name or id of an API is required and it must a string')
            );
        ...
        debug('attempting to delete api %s', apiNameId);
